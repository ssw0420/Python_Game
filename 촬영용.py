...
class Game:
    ...
    def key_frame_set(self):
        self.keys[0] += (self.keyset[0] - self.keys[0]) / (4 * (FPS / self.frame))
        self.keys[1] += (self.keyset[1] - self.keys[1]) / (4 * (FPS / self.frame))
        self.keys[2] += (self.keyset[2] - self.keys[2]) / (4 * (FPS / self.frame))
