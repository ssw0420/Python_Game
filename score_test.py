...
class Game:
    ...
    def __init__(self):
        ...
        self.ingame_font_score = pg.font.Font(os.path.join(self.FontPath, "pdark.ttf"), int(WIDTH / 45))
...
# 임시 잠금
    ...
    def draw_score(self):
        ...
        self.screen.blit(self.score_text, (WIDTH / 2 - self.score_text.get_width() / 2 + 400, FONT_Y * 2 - self.rate_text.get_height() / 2))
